...
void StringFamily::Register(CommandRegistry* registry) {
    ...
    registry->register_command("PING", [](const std::vector<std::string>& args) { return RESPParser::make_simple_string("PONG"); });
    registry->register_command("QUIT", [](const std::vector<std::string>& args) { return RESPParser::make_simple_string("OK"); });
}
